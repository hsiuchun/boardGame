...
public class RunGameCard {
    ...
    public RunGameCard(){
        // System.out.println("RandomList in RunGameCard:"+randomList);
    }
    ...
    public int use(RunPlayer User,Player chooseplayer,Integer cardId,String cardName,int useState){
        switch(cardName) {
            case "Fire!"://good
                ...
                if(useState==0){
                    ...
                    if(test.getBlood()>0){
                        ...
                        // start.changeHashmap(cardId,2);
                        // ArrayList<Integer> randomList=start.getshuffleCard();
                        // System.out.println("erase use carId randomList:"+randomList);
                        start.changeHashmap(cardId, 2);
                        start.shuffleCard();
                        // System.out.println(randomList);
                        // ArrayList<Integer> shufflecard = start.getShuffleCard();
                        // System.out.println("erase use carId randomList:"+randomList);
                        //System.out.println("shuffle randomList:"+shufflecard);
                        return roundState;
                    }
                    else{
            ...
            case "COVID-19"://不要now
                // if(useState==0){
                //     int roundState=1;
                //     System.out.println("Use COVID-19");
                //     System.out.println("U CAN'T USE IT QAQ !!");
                //     ArrayList<Integer> handcard = User.getHandCard();
                //     System.out.println("old handcard"+handcard);
                //     handcard.remove(Integer.valueOf(cardId));
            ...
            case "You Know It"://good
                if(useState==0){
                    ...
                    if(test.getBlood()>0){
                        ...
                        User.setHandCard(handcard);
                        System.out.println("new handcard"+User.getHandCard());
                        // System.out.println("Identify:"+chooseplayer.getIdentify());
