...
public class Player extends JButton implements ActionListener{
    ...
    */
    ...
    public Player(int playerid,int role,int ch){
        ...
        // this.role=String.format("%d",ownPlayer.getRole());
        ...
        // introself.setBackground(new Color(151,142,67));
        ...
        // identify.setBackground(new Color(151,142,67));
        if(playerid==0){
        ...
        // middleself.setBackground(new Color(255,247,247));
        if(playerid==0){
        ...
        // // use GridLayout with downupself.
        // downupself = new JPanel();
        // downupself.setBackground(new Color(151,142,67));

        // downupself.setLayout(new GridLayout(1,2));

        // // add two label into downupself.
        // // attack may need to change JLabel to JPanel later, in order to change the content. In addition, it need to be built in Frame, not in this class.
        // attack=new JLabel("攻距 : 1",JLabel.LEFT);
        // attack.setFont(font);
        // attack.setBackground(new Color(151,142,67));
        // downupself.add(attack);

        // defend=new JLabel("防距 : 1",JLabel.RIGHT);
        // defend.setFont(font);
        // defend.setBackground(new Color(151,142,67));
        // downupself.add(defend);

        // // add downupself into downself.
        // downself.add(downupself);

        // add handed into downself, and add downself into introself.
        // handed may need to change JLabel to JPanel later, in order to change the content. In addition, it need to be built in Frame, not in this class.
        // handed=new JLabel("手牌:"+this.CardNum,JLabel.CENTER);
        // handed.setFont(font);
        // handed.setBackground(new Color(151,142,67));
