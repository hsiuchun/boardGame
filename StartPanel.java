...
public class StartPanel extends JFrame {
    ...
    public StartPanel(){
        ...
        // startButton=new JButton(new ImageIcon("Resource/SDG/go.png"));
        ...
        startButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                // System.out.println("In StartPanel");
            }
        });
    ...
    public class DeskPanel extends JPanel{
        ...
        // private Image deskTop = new ImageIcon("Resource/SDG/1.png").getImage();
