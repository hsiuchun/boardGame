...
public class WhoisDemoFrame extends JFrame implements ActionListener,Runnable{
    ...
    */
    ...
    public WhoisDemoFrame()
    {
        ...
        primary = new Primary();
        // randomList = primary.getshuffleCard();
        // originCardHashmap = primary.getHashMap();
    ...
    private JPanel drawUpPanel(){
        ...
        // buttoPanel.add(up_left_downPanel,BorderLayout.SOUTH);
        ...
        // yesButton.setBackground(new Color(246,194,194));
        ...
        // cancelButton.setBackground(new Color(246,194,194));
        ...
        // endButton.setBackground(new Color(255,130,169));
        ...
        // up_leftPanel.add(buttoPanel,BorderLayout.SOUTH);
        ...
        //Round round2 = new Round(runplayer2,1,originCard);
        // up_centerPanel.add(player2Button);
        // upPanel.add(player2Button);
        ...
        //Round round3 = new Round(runplayer3,1,originCard);
        // up_centerPanel.add(player3Button);
        // upPanel.add(player3Button);
        // add up_centerPanel into upPanel.
        // upPanel.add(up_centerPanel,BorderLayout.CENTER);
        ...
        // status.setBackground(new Color(0,77,97));
        ...
        // cpu_usedPanel.setBorder(BorderFactory.createEmptyBorder(0,30,0,30));
        // up_right_centerPanel.setPreferredSize(new Dimension(120, 160));
        // cpu_attackedPanel = new UpdatePanel();
        // cpu_attackedPanel.setLocation(new Point(1050,150));
        // cpu_attackedPanel.setBackground(new Color(150,177,97));
        
        // up_right_centerPanel.setComponentZOrder(cpu_usedPanel,1);
        ...
        // up_right_centerPanel.add(cpu_attackedPanel);
        // up_right_centerPanel.add(cpu_usedPanel);
        // up_right_centerPanel.setComponentZOrder(cpu_attackedPanel,0);
        // up_right_centerPanel.setComponentZOrder(cpu_usedPanel,0);
        // up_rightPanel.add(up_right_centerPanel);
    ...
    private JPanel drawDownPanel(){
        ...
        // downPanel.setLayout(new BorderLayout(20,10));
        // downPanel.setLayout(new FlowLayout(FlowLayout.CENTER,20,10));
        // downPanel.setLayout(new FlowLayout(FlowLayout.LEFT,20,10));
        downPanel.setLayout(new FlowLayout());
        downPanel.setPreferredSize(new Dimension(1200, 350));
        downPanel.setBackground(new Color(255,245,213));
        // downPanel.setBorder(BorderFactory.createEmptyBorder(10,30,10,30));
        ...
        // personalPanel.add(player0Button);
    ...
    public void run(){
        ...
        // doNothing(20);
        // JOptionPane.showMessageDialog(f, "Cpu回合中", "玩牌", JOptionPane.WARNING_MESSAGE);
        int i =0;
        int roundPlayer=1;
        while(i==0 && roundPlayer<4){
            ...
            if(primary.getPlayer(roundPlayer).getRunPlayer().getBlood()!=0){
                ...
                status.repaint();
                System.out.println("Now is "+roundPlayer+"playing");
                // JOptionPane.showMessageDialog(f, "輪到"+primary.getPlayer(roundPlayer).getPlayerId()+"回合", "換回合", JOptionPane.WARNING_MESSAGE);
                ...
                // computer=new Computer(player1Button,player2Button,player3Button,player0Button);
                System.out.println("attacker blood:"+primary.getPlayer(roundPlayer).getRunPlayer().getBlood());
                // Thread cpu = new Thread(computer);
                // cpu.start();
                ...
                if(computer.getSelfCardId()!=-1){
                    ...
                    // removeUsedCard(new Card(computer.getSelfCardId()));
        ...
        if(primary.getPlayer(0).getRunPlayer().getBlood()>0){
            // Thread changeBlood=new Thread(this);
            // changeBlood.start();
            // System.out.println("Now playing:Player"+round.getPlayer().getPlayerId());
            ...
            while(j==0){
                ...
                if(primary.getPlayer(roundPlayer1).getRunPlayer().getBlood()!=0){
                    ...
                    status.repaint();
                    // int ok = JOptionPane.showConfirmDialog(f, "輪到"+primary.getPlayer(roundPlayer1).getPlayerId()+"回合", "換回合",JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE);
                    ...
                    // primary.getPlayer(roundPlayer1).getHadedPanel().setCardNum(primary.getHandCard(roundPlayer1).size());
                    // primary.getPlayer(roundPlayer1).getHadedPanel().repaint();
    ...
    public void changeBlood(){
        // RunPlayer runplayer=player.getRunPlayer();
        primary.getPlayer(0).getBloodPanel().setBlood(primary.getPlayer(0).getRunPlayer().getBlood());
    ...
    {        
        ...
        if(action.equals("end")){
            if(primary.getPlayer(0).getRunPlayer().getHandCard().size()>primary.getPlayer(0).getRunPlayer().getBlood()){
                // JOptionPane.showMessageDialog(f, "手牌多於血量，因此進到棄牌階段，請點選想棄掉的手牌後按下yes!", "棄牌", JOptionPane.WARNING_MESSAGE);
            ...
            if(action.equals("Yes")){
                if(actionCommand.equals("2")){
                    ...
                    if(cardName.equals("Stock Market Crash")){
                        // if(special1.isVisible()){
                        //     special2.setIcon(new ImageIcon(new ImageIcon("Resource/Card/stockmarketcrash_0_8.png").getImage().getScaledInstance(90, 120,java.awt.Image.SCALE_SMOOTH)));
                        //     special2.setVisible(true);
                        // }
                        // else{
                        //     special1.setIcon(new ImageIcon(new ImageIcon("Resource/Card/stockmarketcrash_0_8.png").getImage().getScaledInstance(90, 120,java.awt.Image.SCALE_SMOOTH)));
                        //     special1.setVisible(true);
                        // } 
                        int heart=0;
                    ...
                    if(cardName.equals("Lottery Jackpot")){
                        // if(special1.isVisible()){
                        //     special2.setIcon(new ImageIcon(new ImageIcon("Resource/Card/lotteryjackpot_2_k.png").getImage().getScaledInstance(90, 120,java.awt.Image.SCALE_SMOOTH)));
                        //     special2.setVisible(true);
                        // }
                        // else{
                        //     special1.setIcon(new ImageIcon(new ImageIcon("Resource/Card/lotteryjackpot_2_k.png").getImage().getScaledInstance(90, 120,java.awt.Image.SCALE_SMOOTH)));
                        //     special1.setVisible(true);
                        // }
                        int heart=0;
                        int roundheartplayer=1;
        ...
        // If this card need to choose the others used, turn to 2nd roundState.
            ...
            if(className.equals("Card")){
                ...
                if(round.getPlayer().HandCardNum()-fold.size()>round.getPlayer().getBlood()){
                    // int ok = JOptionPane.showConfirmDialog(f, "手牌多於血量，請棄牌", "棄牌", JOptionPane.WARNING_MESSAGE);
